...
export default function NewContador() {
  ...
  async function handleCreateUse(event: FormEvent) {
    ...
    try {
      const response = await app.post("/contadorb", {
        email: userEmail,
        nome: userName,
        senha: userSenha,
        cnpj,
    ...
    try {
      const user = await app.post("/user", {
        name: n_fantasia,
        email: userEmail,
        nivel: "5",
        senha: userSenha,
    ...
    <div>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <div className="grid">
          <label htmlFor="" className="">Razão social:</label>
          <input
            id="rz_social"
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <div className="grid">
          <label htmlFor="" className="flex">Senha:</label>
          <input
            id="password"
        ...
        <div className="grid md:grid-cols-3 gap-2">
          <div className="grid grid-cols-2">
         <div className="grid grid-cols-2">
         <label htmlFor="" className="flex flex-col">Cep:
          <input
            id="cep"
            className="w-[95%] h-8 border font-light border-cyan-600 rounded outline-none mr-2 px-1"
            required
          ...
          <label htmlFor="" className="flex flex-col">Cód.Cidade:
          <input
            id="ibge"
            className="w-[95%] h-8 border font-light border-cyan-600 outline-none rounded px-1 mr-2"
            required
         ...
         <div>
          <label htmlFor="" className="flex">Cidade:</label>
          <input
            id="cidade"
            required
            aria-required
          ...
          <div>
          <label htmlFor="" className="flex">Rua:</label>
          <input
            id="endereco"
          ...
          <div>
          <label htmlFor="" className="flex ">Bairro:</label>
          <input
            id="bairro"
            className="w-[100%] h-8 border font-light border-cyan-600 rounded outline-none mr-2 px-1"
            required
        ...
        <div className="grid grid-cols-2">
        <div className="grid grid-cols-2">
         <label htmlFor="" className="flex flex-col">Número:
          <input
            id="numero"
            className="w-[95%] h-8 border font-light border-cyan-600 outline-none rounded px-1 mr-2"
            required
          ...
          <label className="flex flex-col ml-8">UF: 
          <input
            id="uf"
            required
            aria-required
         ...
         <div>
          ...
          <div>
          <label htmlFor="" className="flex"> Nome do Contador:</label>
          <input
