...
export function GraficBloqBoleto() {
  ...
  useEffect(() => {
      ...
      api.get(`/getclientegeraboletofalse`).then((response) => {
    ...
    <div className="flex justify-center items-center md:ml-16 w-[40%] h-[300]">
      <V.VictoryChart domainPadding={35} width={600} height={500}>
        <V.VictoryLabel
          ...
          x={70}
          y={30}
          text="Quantidade de cliente para gerar boleto"
        ></V.VictoryLabel>
